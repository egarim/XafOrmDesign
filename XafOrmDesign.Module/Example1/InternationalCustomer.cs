...
namespace XafOrmDesign.Module.BusinessObjects.Example1
{
    ...
    public class InternationalCustomer : CustomerBase
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        public InternationalCustomer(Session session)
            : base(session)
        {
        }
        ...
        {
            get => deliveryPort;
            set => SetPropertyValue(nameof(DeliveryPort), ref deliveryPort, value);
        }
    }
}